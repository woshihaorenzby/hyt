...
<div style="background-color:#F7F2CC;height:200px;padding-top:50px;">
	...
	<div style="width:200px;height:100px;float:left;padding-left:20px;">
		<div>王东</div>
		<div><img src="<%=path%>/images/card_phone.png" style="width:20px;height:20px;" />&nbsp;<s:property value="user.mpJob" /></div>
		<div><img src="<%=path%>/images/card_phone.png" style="width:20px;height:20px;" />&nbsp;<s:property value="user.mpPhone" /></div>
		<div><img src="<%=path%>/images/card_phone.png" style="width:20px;height:20px;" />&nbsp;<s:property value="user.mpWxcode" /></div>
		<div><img src="<%=path%>/images/card_phone.png" style="width:20px;height:20px;" />&nbsp;<s:property value="user.mpEmail" /></div>
		<div><img src="<%=path%>/images/card_phone.png" style="width:20px;height:20px;" />&nbsp;<s:property value="user.mpCompany" /></div>
	</div>
</div>
