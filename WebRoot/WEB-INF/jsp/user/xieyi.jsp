...
function save() {
	...
	$.ajax({
		...
		dataType: "json",
		data: "hySystem.userAggrement=" + userAggrement,
...
<div class="content_head">
	<font class="head_font">用户协议</font>
</div>
<div class="table_content" style="margin-top:10px;">
	<table class="form_table">
		<tr>
			<td class="table_text" style="vertical-align : middle;width:20%;"><span style="color:red;">*</span>用户协议：</td>
			<td class="table_textright" style="width:50%;">
				<div class="form-group" style="margin:0px;">
					<textarea id="userAggrement" name="userAggrement" style="float:left;"><s:property value="hySystem.userAggrement" /></textarea>
					<div class="errormsg">&nbsp;&nbsp;请填写用户协议！</div>
				</div>
			</td>
		</tr>
		<tr>
