            ...
            return this.each(function () {
                ...
                function showLabels(pageIndex) {
                    ...
                    /*container.append($('<span/>').append($('<b/>').text(pageIndex * settings.recordsperpage + 1)))
                                             ...
                                             .append($('<span/>').text('共'))
                                             .append($('<span/>').append($('<b/>').text(settings.totalrecords+"页")));*/
                    container.append($('<span/>').append($('<b/>').text("共"+Math.ceil(settings.totalrecords/settings.recordsperpage)+"页/"+settings.totalrecords+"条数据")));
                }
