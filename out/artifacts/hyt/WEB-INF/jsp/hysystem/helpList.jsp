	...
	$.ajax({
		...
		success:function(json){
			...
			for(var i=0; i<data.length; i++) {
				...
				appStr += "<td>"+data[i].url+"</td>";
				appStr += "<td>"+data[i].rid+"</td>";
				if(data[i].display=="1") {
					appStr += "<td><img src='<%=path%>/images/button/check_alt.png' width=18 style='cursor:pointer;' hidetag='1' onclick='updateTag(this, \"display\", \"bs_help\")'/></td>";
				} else {
					appStr += "<td><img src='<%=path%>/images/button/x_alt.png' width=18 style='cursor:pointer;'  hidetag='0' onclick='updateTag(this, \"display\", \"bs_help\")'/></td>";
				}
...
<div class="content_head">
	<font class="head_font">帮助中心列表</font>
